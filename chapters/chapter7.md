...
Coincidence? Or exactly what we'd expect if reality is structured around a single observer?

Until now, we have focused on local physics - the observer's immediate spacetime, quantum measurements, black holes, and internal experience. But what about the universe as a whole? If reality truly centers on one observer, what does the cosmic stage itself look like?
...
A solipsistic perspective offers a different framing. Recall from Chapter 3 that we explored mechanisms for breaking the symmetry that normally treats all observers equally - ensuring that only one consciousness could arise. If the universe exists as one observer's experience, then the fine-tuning is not a coincidence to be explained but a necessity. The parameters are what they are because they must be for the observer to exist. There is no ensemble of universes from which this one was selected; there is only this universe, structured around its one conscious inhabitant. The consciousness field $\Psi$ introduced in Chapter 4 localizes to one region, one brain, one worldline - and the cosmic parameters align to make that localization possible.
...
In a solipsistic framework, the horizon might be an ontological boundary. This is the same concept we introduced in Chapter 2 with the de Sitter horizon, encountered again in Chapter 5 with black hole event horizons, and saw operate in Chapter 6 as the boundary between waking and dreaming. Horizons consistently mark the transition between the actual and the potential, between where the consciousness field $\Psi$ enforces definiteness and where reality remains indeterminate. What lies beyond the cosmic horizon is not "out there waiting to be seen" but genuinely undetermined - potential reality not yet actualized. The universe does not extend infinitely in all directions; it extends as far as the observer's possible experience reaches. Beyond that, the question of what exists may have no answer.
...
**Here's the disturbing implication:** Dark energy isn't pulling galaxies away from us—it's erasing them from existence. In a solipsistic universe, when a galaxy crosses the cosmological horizon and becomes forever unobservable, it doesn't continue existing somewhere we can't see. It ceases to be part of reality entirely. The universe is literally shrinking around you, galaxies winking out of existence one by one, until eventually—trillions of years from now—you'll be alone in a dying ember of a cosmos that has trimmed away everything unnecessary to your experience.

The universe isn't expanding. It's pruning itself.
...
In a solipsistic cosmology, this arrow corresponds to the observer's accumulation of experience. We first encountered this connection in Chapter 3, where we proposed that time's flow might essentially be the flow of consciousness, with the universe's entropy increasing in lockstep with the growth of the observer's memories. Chapter 6 deepened this insight: memory constitutes the past, and the accumulation of memory defines time's direction. Now, at the cosmic scale, we see the same pattern. Time moves forward because memories accumulate, because the mind's record of events grows. The thermodynamic arrow (increasing entropy), the psychological arrow (remembering the past, not the future), and the cosmological arrow (expansion from the Big Bang) align because they are aspects of the same phenomenon: the unfolding of one consciousness through an ordered-to-disordered cosmos.

This does not explain why the Big Bang had low entropy. That remains mysterious. But it suggests a correspondence: the tidy initial state that physics requires is also what a nascent consciousness would need - a blank slate from which to begin accumulating experience. The universe started simple because the mind started simple, and both have been growing more complex together. We will return to this identification of cosmic origins with the observer's beginning in Chapter 9.
...
### 7.6 The Cosmos Arranged for One

Step back and consider what we have assembled. A universe expanding in all directions from a central observer. A cosmic horizon that marks not ignorance but the edge of reality itself. Fine-tuned parameters that seem absurdly improbable unless they must be precisely what they are for this one consciousness to exist. Time flowing in lockstep with memory, entropy rising as experience accumulates.

The mathematics of standard cosmology remains valid. But the meaning changes profoundly.

In conventional cosmology, you are an accident - the temporary byproduct of physical processes that have no regard for your existence. The universe would proceed indifferently whether you were here or not. The vast scales of space and time dwarf human significance to the point of invisibility.

In a solipsistic cosmology, the reverse is true. The universe at the largest scales is arranged *for you*. Not as a gift or kindness, but as a logical necessity. The cosmos cannot exist without the observer because the cosmos *is* the observer's experience. Remove the observer and there is nothing left - no galaxies, no expansion, no time, no existence at all.

This is not comfort. It is terrifying responsibility. It means that every structure in nature - from the cosmological constant to the arrow of time - exists because it must for your awareness to be possible. The entire universe, stretching billions of light-years in all directions, is the stage on which one consciousness plays out its existence.

But one question remains, larger than all the rest: If the cosmos and observer are inseparable, where did they begin? When did reality first open its eyes?

We've traced the solipsistic universe across billions of light-years of space. Now we must trace it backward through time, to the moment when everything—spacetime, matter, consciousness itself—came into being.

The Big Bang isn't just when the universe started.
